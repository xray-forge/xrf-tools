...
describe("describeUnpackOutcome", () => {
  it("reports a finished unpack as a success naming both ends", () => {
    ...
    const notification: INotificationPayload = describeUnpackOutcome(SOURCE, DESTINATION, finished);
  ...
  it("reports a failure with the reason", () => {
    const notification: INotificationPayload = describeUnpackOutcome(
      SOURCE,
      DESTINATION,
