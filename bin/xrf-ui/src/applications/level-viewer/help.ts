...
export const LEVEL_VIEWER_HELP: IApplicationHelp = {
  ...
  nuances: [
    ...
    "A compiled level carries occlusion but no light, so what lights it is the viewer's own sun - steer it in the Lighting panel, or take the direction the level was compiled against.",
