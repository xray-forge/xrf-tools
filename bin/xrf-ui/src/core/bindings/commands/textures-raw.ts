...
import { TextureEncodingFormat, TextureSessionId } from "@/core/bindings/types/xrf-app";
...
export const texturesRawCommands = {
  readCandidate: (sessionId: TextureSessionId, format: TextureEncodingFormat): Promise<ArrayBuffer> =>
