...
import { TextureEncodingFormat } from "@/core/bindings/types/xrf-app";
...
export const texturesRawCommands = {
  readCandidate: (format: TextureEncodingFormat): Promise<ArrayBuffer> =>
    invokeRaw("plugin:textures|read_candidate", { format }),
