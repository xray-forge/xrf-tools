...
///
/// A definition names a motion and how to play it; the keyframe count lives in the motion itself,
/// and together they give the effective duration. `keyframes` is absent when a definition points at
/// a motion the file does not carry, which is a real defect in a container rather than a read error.
  ...
  pub fn new(file: &OmfFile) -> Self {
    Self {
      ...
      motions: file
        ...
        .motions
        .iter()
        .map(|definition| OmfMotionReport {
