...
use crate::skeleton_motion_mark::SkeletonMotionMark;
...
impl SkeletonMotionDefinition {
  ...
  /// The definition this crate's own tests and its dependants' fixtures build against.
...
mod tests {
  ...
  use crate::skeleton_motion_definition::SkeletonMotionDefinition;
  use crate::skeleton_motion_mark::SkeletonMotionMark;
