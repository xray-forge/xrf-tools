...
/// The newline a canonical rewrite emits, which is the engine's own.
pub const LTX_LINE_SEPARATOR: &str = "\r\n";

/// What a canonical rewrite puts between a key and its value.
